              ...
              >
                <div className="w-full h-full bg-gray-800 flex items-center justify-center relative overflow-hidden">
                  <motion.div
                    ...
                    className="absolute inset-0 bg-gradient-to-br from-yellow-500/10 to-yellow-600/10"
                  ></motion.div>
                  <p className="text-gray-500 text-lg md:text-xl relative z-10">Map Placeholder</p>
                </div>
              </motion.div>
            </div>
          </div>
